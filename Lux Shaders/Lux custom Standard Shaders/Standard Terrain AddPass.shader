Shader "Hidden/Lux/Terrain/Lux-Standard-AddPass" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputLuxStandardSpecular o) {
			...
			LUX_SETUP(IN.tc_Control, float2(0,0), IN.viewDir, IN.lux_worldPosDistance.xyz, IN.lux_worldPosDistance.w, float2(0,0), half4(1,1,1,1))
